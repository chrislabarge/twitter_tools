...
class ApiOauthRequest
	...
	def initialize()
		...
		@keys['consumer_key'] = ENV['TWITTER_CONSUMER_KEY']
		@keys['consumer_secret'] = ENV['TWITTER_CONSUMER_SECRET']
		@keys['access_token'] = ENV['TWITTER_TOKEN']
		@keys['access_token_secret'] = ENV['TWITTER_SECRET']
